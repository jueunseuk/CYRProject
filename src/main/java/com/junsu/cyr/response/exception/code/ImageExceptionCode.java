...
public enum ImageExceptionCode implements ExceptionCode {
    FAILED_TO_UPLOAD_IMAGE("IMAGE_001", "이미지를 업로드하는 데 실패했습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
    ...
    IMAGE_SIZE_EXCEEDED("IMAGE_004", "이미지의 크기가 너무 큽니다.", HttpStatus.BAD_REQUEST ),
    INVALID_IMAGE_NAME("IMAGE_005", "이미지의 이름이 유효하지 않습니다.", HttpStatus.BAD_REQUEST),
    ;
